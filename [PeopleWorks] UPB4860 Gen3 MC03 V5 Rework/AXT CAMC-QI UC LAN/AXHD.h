...
typedef enum _IPCOMMAND
{
    ...
    // Interpolation Group    Regist    ers
...
{                                       
    // Previous register and etc Reg    isters
    ...
    // Configure and Stat usregisters
...
{                                                            
    ...
    EVENT_QIINPWAIT                                          = 0xA7,    // In position wait event occurred.
    EVENT_QILINSTR                                           = 0xA8,    // Linear drive stated.
    EVENT_QICIRSTR                                           = 0xA9,    // Circular drive started.
    EVENT_QIDRVENDII                                         = 0xAA,    // Drive stopped.(In position state included)
    ...
    EVENT_QIINPEND                                           = 0xB6,    // Escape from In position waiting.
